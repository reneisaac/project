        ...
        <form name="regiClient" novalidate>
            <div class="columna-6">
                <div class="form-grupo form-texto-animado">
                    <input type="text" class="input-text" required="" ng-maxlength="100" name="nombre"
                           ng-model="data.nombre" required>
            ...
            <div class="columna-6">
                <div class="form-grupo form-texto-animado">
                    <input type="text" class="input-text" ng-minlength="8" ng-maxlength="12" name="cel"
                           ng-pattern="/^[0-9]*$/" ng-model="data.cel" required>
            ...
            <div class="columna-6">
                <div class="form-grupo form-texto-animado">
                    <input type="text" class="input-text" ng-minlength="13" ng-maxlength="13" ng-pattern="/^[0-9]*$/"
                           name="identi" ng-model="data.identi" required>
            ...
            <div class="columna-6">
                <div class="form-grupo form-texto-animado">
                    <input type="text" class="input-text" name="rtn" ng-minlength="14" ng-maxlength="14"
                           ng-pattern="/^[0-9]*$/" ng-model="data.rtn" required>
            ...
            <div class="columna-6">
                <div class="form-grupo form-texto-animado">
                    <input type="text" class="input-text" ng-maxlength="9" ng-pattern="/^[0-9.]*$/" name="ingreso"
                           ng-model="data.ingre" required>
            ...
            <div class="columna-2">
                <button class="btn form verde pull-left"
                        ng-disabled="!regiClient.$pristine && regiClient.ingreso.$error.required || regiClient.ingreso.$error.pattern || regiClient.ingreso.$error.maxlength"
                        ng-click="calCuota(data.ingre)">Calcular cuota
                </button>
            </div>
            ...
            <div class="columna-12">
                <button class="btn form verde pull-right" ng-disabled="!regiClient.$valid" ng-click="guarClient(data)">
                    Guardar cliente
                </button>
            </div>
        </form>
