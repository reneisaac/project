        ...
        <form name="regiClient" novalidate>
            <div class="columna-6">
                <div class="form-grupo form-texto-animado">
                    <input type="text" class="input-text" ng-maxlength="100" name="nombre" ng-model="data.nombre" required>
            ...
            <div class="columna-6">
                <div class="form-grupo form-texto-animado">
                    <input type="text" class="input-text" ng-minlength="8" ng-maxlength="12" name="cel" ng-pattern="/^[0-9]*$/" ng-model="data.cel" required>
            ...
            <div class="columna-12">
                <button class="btn form verde pull-right" ng-disabled="!regiClient.$valid" ng-click="guarClient(data)">Modificar datos del cliente</button>
