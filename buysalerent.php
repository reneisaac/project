...
<div class="inside-banner">
  <div class="container"> 
<!--    <span class="pull-right"><a href="index.php">Home</a> / Compra, Vende y Renta</span>-->
    <h2>¡Obtén tu vivienda ya!</h2>
</div>
</div>
<!-- banner -->
...
<div class="col-lg-3 col-sm-4 ">
  ...
  <div class="search-form"><h4><span class="glyphicon glyphicon-search"></span> Buscar por</h4>
    <input type="text" class="form-control" placeholder="Busca Propiedades">
    <div class="row">
            <div class="col-lg-5">
...
<!--                <option>Vender</option>-->
            ...
            <div class="col-lg-7">
              <select class="form-control">
                ...
                <option>Lps 700,000 - 800,000</option>
                <option>Lps800,000 - 900,000</option>
                <option>Lps 1000,000 - 2000,000</option>
                <option>Lps 3000,000- 4000000</option>
				<option>Lps 4000,000 en adelante</option>
              </select>
            </div>
          </div>
